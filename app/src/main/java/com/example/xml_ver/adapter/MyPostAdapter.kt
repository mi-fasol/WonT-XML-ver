...
) : ListAdapter<PostResponseModel, MyPostAdapter.PostViewHolder>(PostDiffCallback()) {
    ...
    inner class PostViewHolder(private val binding: ItemPostBinding) :
        ...
        fun bind(post: PostResponseModel) {
            ...
            CoroutineScope(Dispatchers.Main).launch {
                ...
                acceptationViewModel.attendeeModelList.collect {
                    val person = it[post.pId] ?: emptyList()
                    binding.person.text = "${person.size}/${post.person}"
                }
            }
        }
    }
