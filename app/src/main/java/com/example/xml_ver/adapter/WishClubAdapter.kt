...
import com.example.xml_ver.databinding.ItemWishClubBinding
...
class WishClubAdapter(
    private val wishViewModel: WishViewModel,
    private val mainViewModel: MainViewModel
) : ListAdapter<ClubPostResponseModel, WishClubAdapter.PostViewHolder>(ClubPostDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostViewHolder {
        val binding =
            ItemWishClubBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class PostViewHolder(private val binding: ItemWishClubBinding) :
        ...
        fun bind(post: ClubPostResponseModel) {
            ...
            binding.wishButton.setOnClickListener {
                CoroutineScope(Dispatchers.Main).launch {
                    Log.d("미란", "눌려떠용")
                    wishViewModel.changeWish(post.pId, 2, isWished)
                    isWished = !isWished
